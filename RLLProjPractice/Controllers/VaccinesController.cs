...
namespace RLLProjPractice.Controllers
{
    public class VaccinesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VaccineID,VaccineName,VaccineDescription")] Vaccine vaccine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VaccineID,VaccineName,VaccineDescription")] Vaccine vaccine)
        {
            if (ModelState.IsValid)
            {
